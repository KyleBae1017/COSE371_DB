...
(
	...
	is_reviewed varchar(10) not null check (is_reviewed in ('true', 'false')),
...
INSERT INTO enrollment VALUES('postgres', 'admin', '00', 'korean history', 1000, 'false');

INSERT INTO request VALUES('postgres', 'admin', 'western history');
